...
router.post('', checkAuth, multer({storage: storage}).single("image"), (req, res, next) => {       //this means multer will now try to  extract a single file from the incomin req and will try to find it on an image property in the req body
